...
export const DATA_GAPS: DataGap[] = [
  ...
  // Vision / OCR
  {
    ...
    status: 'sparse',
    description: 'BSTD and IIIT-HW exist but are small. No large-scale Marathi street sign / billboard dataset.',
  ...
  },
  {
    ...
    category: 'vision-ocr-multimodal',
    status: 'missing',
    description: 'No dataset for parsing Marathi document layouts (government forms, certificates, gazettes).',
    benchmark: 'English has PubLayNet, DocBank. Chinese has CDLA.',
    opportunity: 'Key for digitizing Maharashtra government records and automating form processing.',
  },
  ...
  },
  {
    ...
    category: 'economy-labour-finance',
    status: 'sparse',
    description: 'Udyam has registration data but no structured dataset with financials, sectors, or outcomes.',
